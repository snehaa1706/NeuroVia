...
export default function StandaloneScreeningPage() {
    ...
    // ─── Minimal Top Bar for Standalone ───
    const TopBar = () => (
        <header className="h-14 bg-white border-b border-slate-100 flex items-center justify-between px-6 shadow-sm sticky top-0 z-40">
            <div className="flex items-center gap-3">
                ...
                <span className="font-extrabold text-slate-800 tracking-tight">NeuroVia Screening</span>
            </div>
            <button
                onClick={() => navigate('/')}
                className="flex items-center gap-2 text-sm font-medium text-slate-500 hover:text-slate-800 transition-colors px-3 py-1.5 rounded-lg hover:bg-slate-50"
            >
                ...
                <div className="p-8 max-w-4xl mx-auto animate-in fade-in duration-500 min-h-[80vh] flex flex-col justify-center">
                    <div className="text-center mb-12 relative animate-in slide-in-from-bottom-5 duration-700">
                        ...
                        <p className="text-slate-500 text-lg md:text-xl font-medium max-w-2xl mx-auto relative z-10">
                            Select an assessment level to begin. No account required.
                        </p>
                    </div>
                        ...
                        {LEVELS.map((level, i) => {
                            ...
                            return (
                                <button
                                    ...
                                    disabled={loading}
                                    className={`group w-full p-6 md:p-8 rounded-3xl border-2 border-slate-100 bg-white hover:border-transparent text-left transition-all duration-300 relative overflow-hidden flex flex-col md:flex-row items-start md:items-center gap-6`}
                                ...
                                >
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <p className="text-slate-500 text-base md:text-lg mb-4 leading-relaxed font-medium">{level.description}</p>
                                        <div className="flex flex-wrap gap-2">
                                            {level.tests.map((test) => (
                                                <span key={test} className="bg-slate-50 border border-slate-200 text-slate-600 text-sm font-semibold px-4 py-1.5 rounded-full">{test}</span>
                                            ))}
                                        </div>
                                    </div>
            ...
            <div className="min-h-screen bg-[#F8FAFC]">
                ...
                <div className="p-8 max-w-3xl mx-auto animate-in fade-in slide-in-from-bottom-8 duration-700">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                        <button onClick={() => navigate('/')} className="flex-1 py-4 bg-white border-2 border-slate-200 text-slate-700 font-bold rounded-2xl hover:bg-slate-50 hover:border-slate-300 transition-all text-lg">
                            Back to Home
                        </button>
                        <button onClick={() => navigate('/login')} className="flex-1 py-4 bg-slate-900 text-white font-bold rounded-2xl hover:bg-slate-800 transition-all text-lg shadow-lg shadow-slate-900/20">
                    ...
                    {selectedLevel === 'mci' && currentTest === 1 && (
                        <div className="animate-in slide-in-from-right-8 duration-500">
                            ...
                            <div className="grid sm:grid-cols-2 gap-8">
                                ...
                                <div>
                                    <label className="block text-slate-800 font-bold mb-3 text-lg">Errors</label>
